...
- [#5958](https://github.com/ChainSafe/forest/issues/5958): Repository-wide spellcheck for markdown files including .github directory with automated CI validation.
...
- [#4603](https://github.com/ChainSafe/forest/pull/4603) Fixed incorrect
  deserialization in `Filecoin.EthGetBlockByNumber` and
